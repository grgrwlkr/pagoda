...
func (_c *ChannelCreate) SetWorkspaceID(v int) *ChannelCreate {
	_c.mutation.SetWorkspaceID(v)
	return _c
}

// SetCreatedBy sets the "created_by" field.
func (_c *ChannelCreate) SetCreatedBy(v int) *ChannelCreate {
...
func (_c *ChannelCreate) SetCreatorID(id int) *ChannelCreate {
	_c.mutation.SetCreatorID(id)
	return _c
}

// SetCreator sets the "creator" edge to the User entity.
func (_c *ChannelCreate) SetCreator(v *User) *ChannelCreate {
	return _c.SetCreatorID(v.ID)
}

// AddMemberIDs adds the "members" edge to the ChannelMember entity by IDs.
func (_c *ChannelCreate) AddMemberIDs(ids ...int) *ChannelCreate {
...
func (_c *ChannelCreate) AddMessageIDs(ids ...int) *ChannelCreate {
...
func (_c *ChannelCreate) check() error {
	...
	if len(_c.mutation.CreatorIDs()) == 0 {
		return &ValidationError{Name: "creator", err: errors.New(`ent: missing required edge "Channel.creator"`)}
	}
	return nil
}
