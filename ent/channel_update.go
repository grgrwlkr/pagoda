...
func (_u *ChannelUpdate) SetWorkspaceID(v int) *ChannelUpdate {
	_u.mutation.SetWorkspaceID(v)
	return _u
}

// SetNillableWorkspaceID sets the "workspace_id" field if the given value is not nil.
func (_u *ChannelUpdate) SetNillableWorkspaceID(v *int) *ChannelUpdate {
	if v != nil {
		_u.SetWorkspaceID(*v)
	}
	return _u
...
func (_u *ChannelUpdate) SetCreatedBy(v int) *ChannelUpdate {
	_u.mutation.SetCreatedBy(v)
	return _u
}

// SetNillableCreatedBy sets the "created_by" field if the given value is not nil.
func (_u *ChannelUpdate) SetNillableCreatedBy(v *int) *ChannelUpdate {
	if v != nil {
		_u.SetCreatedBy(*v)
	}
	return _u
...
func (_u *ChannelUpdate) SetCreatorID(id int) *ChannelUpdate {
	_u.mutation.SetCreatorID(id)
	return _u
}

// SetCreator sets the "creator" edge to the User entity.
func (_u *ChannelUpdate) SetCreator(v *User) *ChannelUpdate {
	return _u.SetCreatorID(v.ID)
}

// AddMemberIDs adds the "members" edge to the ChannelMember entity by IDs.
func (_u *ChannelUpdate) AddMemberIDs(ids ...int) *ChannelUpdate {
...
func (_u *ChannelUpdate) AddMessageIDs(ids ...int) *ChannelUpdate {
...
func (_u *ChannelUpdate) ClearCreator() *ChannelUpdate {
...
func (_u *ChannelUpdate) RemoveMemberIDs(ids ...int) *ChannelUpdate {
...
func (_u *ChannelUpdate) RemoveMessageIDs(ids ...int) *ChannelUpdate {
...
func (_u *ChannelUpdate) check() error {
	...
	if v, ok := _u.mutation.Description(); ok {
		if err := channel.DescriptionValidator(v); err != nil {
			return &ValidationError{Name: "description", err: fmt.Errorf(`ent: validator failed for field "Channel.description": %w`, err)}
		}
	}
	...
	if _u.mutation.CreatorCleared() && len(_u.mutation.CreatorIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Channel.creator"`)
	}
	return nil
}
...
func (_u *ChannelUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.CreatorCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   channel.CreatorTable,
			Columns: []string{channel.CreatorColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if _u.mutation.MembersCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(channelmember.FieldID, field.TypeInt),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
...
// SetWorkspaceID sets the "workspace_id" field.
func (_u *ChannelUpdateOne) SetWorkspaceID(v int) *ChannelUpdateOne {
	_u.mutation.SetWorkspaceID(v)
	return _u
}

// SetNillableWorkspaceID sets the "workspace_id" field if the given value is not nil.
func (_u *ChannelUpdateOne) SetNillableWorkspaceID(v *int) *ChannelUpdateOne {
	if v != nil {
		_u.SetWorkspaceID(*v)
	}
	return _u
...
// SetCreatedBy sets the "created_by" field.
func (_u *ChannelUpdateOne) SetCreatedBy(v int) *ChannelUpdateOne {
	_u.mutation.SetCreatedBy(v)
	return _u
}

// SetNillableCreatedBy sets the "created_by" field if the given value is not nil.
func (_u *ChannelUpdateOne) SetNillableCreatedBy(v *int) *ChannelUpdateOne {
	if v != nil {
		_u.SetCreatedBy(*v)
	}
	return _u
...
// SetCreatorID sets the "creator" edge to the User entity by ID.
func (_u *ChannelUpdateOne) SetCreatorID(id int) *ChannelUpdateOne {
	_u.mutation.SetCreatorID(id)
	return _u
}

// SetCreator sets the "creator" edge to the User entity.
func (_u *ChannelUpdateOne) SetCreator(v *User) *ChannelUpdateOne {
	return _u.SetCreatorID(v.ID)
}

// AddMemberIDs adds the "members" edge to the ChannelMember entity by IDs.
func (_u *ChannelUpdateOne) AddMemberIDs(ids ...int) *ChannelUpdateOne {
	_u.mutation.AddMemberIDs(ids...)
	return _u
}
...
// AddMessageIDs adds the "messages" edge to the Message entity by IDs.
func (_u *ChannelUpdateOne) AddMessageIDs(ids ...int) *ChannelUpdateOne {
	_u.mutation.AddMessageIDs(ids...)
	return _u
}
...
// ClearCreator clears the "creator" edge to the User entity.
func (_u *ChannelUpdateOne) ClearCreator() *ChannelUpdateOne {
	_u.mutation.ClearCreator()
	return _u
}
...
// RemoveMemberIDs removes the "members" edge to ChannelMember entities by IDs.
func (_u *ChannelUpdateOne) RemoveMemberIDs(ids ...int) *ChannelUpdateOne {
	_u.mutation.RemoveMemberIDs(ids...)
	return _u
}
...
// RemoveMessageIDs removes the "messages" edge to Message entities by IDs.
func (_u *ChannelUpdateOne) RemoveMessageIDs(ids ...int) *ChannelUpdateOne {
	_u.mutation.RemoveMessageIDs(ids...)
	return _u
}
