...
func (_c *MessageCreate) SetChannelID(v int) *MessageCreate {
	_c.mutation.SetChannelID(v)
	return _c
}

// SetUserID sets the "user_id" field.
func (_c *MessageCreate) SetUserID(v int) *MessageCreate {
	_c.mutation.SetUserID(v)
	return _c
}

// SetThreadID sets the "thread_id" field.
func (_c *MessageCreate) SetThreadID(v int) *MessageCreate {
	_c.mutation.SetThreadID(v)
	return _c
}

// SetNillableThreadID sets the "thread_id" field if the given value is not nil.
func (_c *MessageCreate) SetNillableThreadID(v *int) *MessageCreate {
	if v != nil {
		_c.SetThreadID(*v)
	}
	return _c
...
func (_c *MessageCreate) SetReplyCount(v int) *MessageCreate {
	_c.mutation.SetReplyCount(v)
	return _c
}

// SetNillableReplyCount sets the "reply_count" field if the given value is not nil.
func (_c *MessageCreate) SetNillableReplyCount(v *int) *MessageCreate {
	if v != nil {
		_c.SetReplyCount(*v)
	}
	return _c
...
func (_c *MessageCreate) SetThread(v *Message) *MessageCreate {
...
func (_c *MessageCreate) AddReactionIDs(ids ...int) *MessageCreate {
...
func (_c *MessageCreate) check() error {
	...
	if _, ok := _c.mutation.ReplyCount(); !ok {
		return &ValidationError{Name: "reply_count", err: errors.New(`ent: missing required field "Message.reply_count"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
