...
4. **Документируйте** причину использования JavaScript в комментариях к коду:
   ```go
...
5. **Вынесите** JavaScript в отдельные файлы в `static/js/` (не встраивайте в HTML)

6. **Минимизируйте** количество JavaScript кода
